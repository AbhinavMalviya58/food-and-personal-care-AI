  ...
  return (
    ...
    >
      <div className='flex flex-col items-center gap-8 mx-auto'>
        ...
        <div className='flex flex-1 flex-col items-center gap-8 overflow-y-auto px-8'>
          <div className='w-full lg:w-[60%]'>
        ...
        <div className='w-full lg:w-[60%] flex flex-col gap-4'>
          ...
          <div className='flex gap-4 items-end'>
            <Button onClick={() => {}} variant='app-primary'>
              <Paperclip />
            </Button>
            <Input
              className='flex-1'
              ...
              value={message}
            />
            <Button onClick={onSubmit} variant='app-primary'>
              <SendHorizonalIcon />
            </Button>
          </div>
        </div>
